ALL=01-interactive-prompt 02-using-editline 03-mpc-parser 04-evaluation 05-error 06-sexpr 07-qexpr 08-environment 09-function
CC=cc
...
08-environment: 08-environment.c
	$(CC) -o $@ $^ mpc.c -lm -ledit

09-function: 09-function.c
	$(CC) -o $@ $^ mpc.c -lm -ledit
